...
\begin{defn}[Notations Surjection]\index{notations}\index{surjectivite}\label{def:notations_injection}
...
\begin{defn}[Notations Bijection]\index{notations}\index{bijectivite}\label{def:notations_injection}
